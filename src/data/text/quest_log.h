...
const u8 gText_QuestLog_PlayerBattledChampionRival[] = _("{DYNAMIC 0x00} had a pointless battle\nwith the CHAMPION, {DYNAMIC 0x01}.");
...
const u8 gText_QuestLog_WonTheMatchAsAResult[] = _("And, as a result of copying his\nevery action, {DYNAMIC 0x00} somehow won\nthe match.");
...
const u8 gText_QuestLog_Handily[] = _("stupidly");
const u8 gText_QuestLog_Tenaciously[] = _("unoriginally");
