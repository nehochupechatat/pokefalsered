...
#define MAP_SSANNE_EXTERIOR                      (2 | (1 << 8))
#define MAP_SSANNE_1F_CORRIDOR                   (3 | (1 << 8))
#define MAP_SSANNE_2F_CORRIDOR                   (4 | (1 << 8))
#define MAP_SSANNE_3F_CORRIDOR                   (5 | (1 << 8))
#define MAP_SSANNE_B1F_CORRIDOR                  (6 | (1 << 8))
#define MAP_SSANNE_DECK                          (7 | (1 << 8))
#define MAP_SSANNE_KITCHEN                       (8 | (1 << 8))
#define MAP_SSANNE_CAPTAINS_OFFICE               (9 | (1 << 8))
#define MAP_SSANNE_1F_ROOM1                      (10 | (1 << 8))
#define MAP_SSANNE_1F_ROOM2                      (11 | (1 << 8))
#define MAP_SSANNE_1F_ROOM3                      (12 | (1 << 8))
#define MAP_SSANNE_1F_ROOM4                      (13 | (1 << 8))
#define MAP_SSANNE_1F_ROOM5                      (14 | (1 << 8))
#define MAP_SSANNE_1F_ROOM7                      (15 | (1 << 8))
#define MAP_SSANNE_2F_ROOM1                      (16 | (1 << 8))
#define MAP_SSANNE_2F_ROOM2                      (17 | (1 << 8))
#define MAP_SSANNE_2F_ROOM3                      (18 | (1 << 8))
#define MAP_SSANNE_2F_ROOM4                      (19 | (1 << 8))
#define MAP_SSANNE_2F_ROOM5                      (20 | (1 << 8))
#define MAP_SSANNE_2F_ROOM6                      (21 | (1 << 8))
#define MAP_SSANNE_B1F_ROOM1                     (22 | (1 << 8))
#define MAP_SSANNE_B1F_ROOM2                     (23 | (1 << 8))
#define MAP_SSANNE_B1F_ROOM3                     (24 | (1 << 8))
#define MAP_SSANNE_B1F_ROOM4                     (25 | (1 << 8))
#define MAP_SSANNE_B1F_ROOM5                     (26 | (1 << 8))
#define MAP_SSANNE_1F_ROOM6                      (27 | (1 << 8))
#define MAP_UNDERGROUND_PATH_NORTH_ENTRANCE      (28 | (1 << 8))
#define MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL  (29 | (1 << 8))
#define MAP_UNDERGROUND_PATH_SOUTH_ENTRANCE      (30 | (1 << 8))
#define MAP_UNDERGROUND_PATH_WEST_ENTRANCE       (31 | (1 << 8))
#define MAP_UNDERGROUND_PATH_EAST_WEST_TUNNEL    (32 | (1 << 8))
#define MAP_UNDERGROUND_PATH_EAST_ENTRANCE       (33 | (1 << 8))
#define MAP_DIGLETTS_CAVE_NORTH_ENTRANCE         (34 | (1 << 8))
#define MAP_DIGLETTS_CAVE_B1F                    (35 | (1 << 8))
#define MAP_DIGLETTS_CAVE_SOUTH_ENTRANCE         (36 | (1 << 8))
#define MAP_VICTORY_ROAD_1F                      (37 | (1 << 8))
#define MAP_VICTORY_ROAD_2F                      (38 | (1 << 8))
#define MAP_VICTORY_ROAD_3F                      (39 | (1 << 8))
#define MAP_ROCKET_HIDEOUT_B1F                   (40 | (1 << 8))
#define MAP_ROCKET_HIDEOUT_B3F                   (41 | (1 << 8))
#define MAP_ROCKET_HIDEOUT_B4F                   (42 | (1 << 8))
#define MAP_ROCKET_HIDEOUT_ELEVATOR              (43 | (1 << 8))
#define MAP_SILPH_CO_1F                          (44 | (1 << 8))
#define MAP_SILPH_CO_2F                          (45 | (1 << 8))
#define MAP_SILPH_CO_3F                          (46 | (1 << 8))
#define MAP_SILPH_CO_4F                          (47 | (1 << 8))
#define MAP_SILPH_CO_5F                          (48 | (1 << 8))
#define MAP_SILPH_CO_6F                          (49 | (1 << 8))
#define MAP_SILPH_CO_7F                          (50 | (1 << 8))
#define MAP_SILPH_CO_8F                          (51 | (1 << 8))
#define MAP_SILPH_CO_9F                          (52 | (1 << 8))
#define MAP_SILPH_CO_10F                         (53 | (1 << 8))
#define MAP_SILPH_CO_11F                         (54 | (1 << 8))
#define MAP_SILPH_CO_ELEVATOR                    (55 | (1 << 8))
#define MAP_POKEMON_MANSION_1F                   (56 | (1 << 8))
#define MAP_POKEMON_MANSION_2F                   (57 | (1 << 8))
#define MAP_POKEMON_MANSION_3F                   (58 | (1 << 8))
#define MAP_POKEMON_MANSION_B1F                  (59 | (1 << 8))
#define MAP_SAFARI_ZONE_CENTER                   (60 | (1 << 8))
#define MAP_SAFARI_ZONE_EAST                     (61 | (1 << 8))
#define MAP_SAFARI_ZONE_NORTH                    (62 | (1 << 8))
#define MAP_SAFARI_ZONE_WEST                     (63 | (1 << 8))
#define MAP_SAFARI_ZONE_CENTER_REST_HOUSE        (64 | (1 << 8))
#define MAP_SAFARI_ZONE_EAST_REST_HOUSE          (65 | (1 << 8))
#define MAP_SAFARI_ZONE_NORTH_REST_HOUSE         (66 | (1 << 8))
#define MAP_SAFARI_ZONE_WEST_REST_HOUSE          (67 | (1 << 8))
#define MAP_SAFARI_ZONE_SECRET_HOUSE             (68 | (1 << 8))
#define MAP_CERULEAN_CAVE_1F                     (69 | (1 << 8))
#define MAP_CERULEAN_CAVE_2F                     (70 | (1 << 8))
#define MAP_CERULEAN_CAVE_B1F                    (71 | (1 << 8))
#define MAP_POKEMON_LEAGUE_LORELEIS_ROOM         (72 | (1 << 8))
#define MAP_POKEMON_LEAGUE_BRUNOS_ROOM           (73 | (1 << 8))
#define MAP_POKEMON_LEAGUE_AGATHAS_ROOM          (74 | (1 << 8))
#define MAP_POKEMON_LEAGUE_LANCES_ROOM           (75 | (1 << 8))
#define MAP_POKEMON_LEAGUE_CHAMPIONS_ROOM        (76 | (1 << 8))
#define MAP_POKEMON_LEAGUE_HALL_OF_FAME          (77 | (1 << 8))
#define MAP_ROCK_TUNNEL_1F                       (78 | (1 << 8))
#define MAP_ROCK_TUNNEL_B1F                      (79 | (1 << 8))
#define MAP_SEAFOAM_ISLANDS_1F                   (80 | (1 << 8))
#define MAP_SEAFOAM_ISLANDS_B1F                  (81 | (1 << 8))
#define MAP_SEAFOAM_ISLANDS_B2F                  (82 | (1 << 8))
#define MAP_SEAFOAM_ISLANDS_B3F                  (83 | (1 << 8))
#define MAP_SEAFOAM_ISLANDS_B4F                  (84 | (1 << 8))
#define MAP_POKEMON_TOWER_1F                     (85 | (1 << 8))
#define MAP_POKEMON_TOWER_2F                     (86 | (1 << 8))
#define MAP_POKEMON_TOWER_3F                     (87 | (1 << 8))
#define MAP_POKEMON_TOWER_4F                     (88 | (1 << 8))
#define MAP_POKEMON_TOWER_5F                     (89 | (1 << 8))
#define MAP_POKEMON_TOWER_6F                     (90 | (1 << 8))
#define MAP_POKEMON_TOWER_7F                     (91 | (1 << 8))
#define MAP_POWER_PLANT                          (92 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_B4F               (93 | (1 << 8))
#define MAP_MT_EMBER_EXTERIOR                    (94 | (1 << 8))
#define MAP_MT_EMBER_SUMMIT_PATH_1F              (95 | (1 << 8))
#define MAP_MT_EMBER_SUMMIT_PATH_2F              (96 | (1 << 8))
#define MAP_MT_EMBER_SUMMIT_PATH_3F              (97 | (1 << 8))
#define MAP_MT_EMBER_SUMMIT                      (98 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_B5F               (99 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_1F                (100 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_B1F               (101 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_B2F               (102 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_B3F               (103 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_B1F_STAIRS        (104 | (1 << 8))
#define MAP_MT_EMBER_RUBY_PATH_B2F_STAIRS        (105 | (1 << 8))
#define MAP_THREE_ISLAND_BERRY_FOREST            (106 | (1 << 8))
#define MAP_FOUR_ISLAND_ICEFALL_CAVE_ENTRANCE    (107 | (1 << 8))
#define MAP_FOUR_ISLAND_ICEFALL_CAVE_1F          (108 | (1 << 8))
#define MAP_FOUR_ISLAND_ICEFALL_CAVE_B1F         (109 | (1 << 8))
#define MAP_FOUR_ISLAND_ICEFALL_CAVE_BACK        (110 | (1 << 8))
#define MAP_FIVE_ISLAND_ROCKET_WAREHOUSE         (111 | (1 << 8))
#define MAP_SIX_ISLAND_DOTTED_HOLE_1F            (112 | (1 << 8))
#define MAP_SIX_ISLAND_DOTTED_HOLE_B1F           (113 | (1 << 8))
#define MAP_SIX_ISLAND_DOTTED_HOLE_B2F           (114 | (1 << 8))
#define MAP_SIX_ISLAND_DOTTED_HOLE_B3F           (115 | (1 << 8))
#define MAP_SIX_ISLAND_DOTTED_HOLE_B4F           (116 | (1 << 8))
#define MAP_SIX_ISLAND_DOTTED_HOLE_SAPPHIRE_ROOM (117 | (1 << 8))
#define MAP_SIX_ISLAND_PATTERN_BUSH              (118 | (1 << 8))
#define MAP_SIX_ISLAND_ALTERING_CAVE             (119 | (1 << 8))
